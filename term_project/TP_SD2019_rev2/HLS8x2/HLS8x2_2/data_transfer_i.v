...
reg   [68:0] indvar_flatten1_reg_200;
reg   [31:0] i_reg_211;
reg   [36:0] indvar_flatten_reg_220;
reg   [4:0] j_reg_231;
reg   [31:0] k_reg_242;
wire   [2:0] tmp_15_fu_261_p1;
reg   [2:0] tmp_15_reg_503;
wire   [6:0] tmp_4_fu_283_p2;
reg   [6:0] tmp_4_reg_508;
wire  signed [4:0] f_cast_fu_289_p1;
reg  signed [4:0] f_cast_reg_513;
...
wire   [68:0] bound6_fu_329_p2;
reg   [68:0] bound6_reg_535;
...
wire   [68:0] indvar_flatten_next1_fu_346_p2;
...
wire   [4:0] tmp_4_mid2_fu_421_p3;
reg   [4:0] tmp_4_mid2_reg_563;
reg   [15:0] ifmap_read_reg_570;
reg   [15:0] ap_reg_pp0_iter1_ifmap_read_reg_570;
wire   [10:0] tmp_20_fu_429_p1;
reg   [10:0] tmp_20_reg_582;
wire   [31:0] k_2_fu_433_p2;
wire   [36:0] indvar_flatten_next_fu_445_p3;
wire   [10:0] tmp_6_fu_481_p2;
reg   [10:0] tmp_6_reg_597;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state3;
reg    ap_enable_reg_pp0_iter1;
reg    ap_enable_reg_pp0_iter2;
reg   [31:0] ap_phi_mux_i_phi_fu_214_p4;
reg   [4:0] ap_phi_mux_j_phi_fu_235_p4;
wire   [63:0] tmp_17_cast_fu_487_p1;
wire   [5:0] tmp_12_fu_251_p1;
wire   [5:0] tmp_fu_255_p2;
wire   [0:0] tmp_3_fu_265_p2;
wire   [5:0] smax3_fu_271_p3;
wire   [6:0] smax3_cast_fu_279_p1;
wire   [5:0] f_cast2_cast1_fu_297_p1;
wire   [5:0] tmp_s_fu_308_p2;
wire  signed [31:0] tmp_14_cast_fu_322_p1;
wire   [31:0] bound6_fu_329_p1;
wire   [6:0] f_cast2_cast_fu_301_p1;
wire   [6:0] tmp_11_cast_fu_318_p1;
wire   [0:0] exitcond_flatten_fu_358_p2;
wire   [31:0] i_1_fu_352_p2;
wire   [2:0] tmp_18_fu_387_p1;
wire   [0:0] exitcond_fu_396_p2;
wire   [4:0] j_mid_fu_364_p3;
wire   [0:0] exitcond1_mid1_fu_401_p3;
wire   [31:0] k_mid_fu_372_p3;
wire   [4:0] j_2_fu_408_p2;
wire   [31:0] k_mid2_fu_414_p3;
wire   [36:0] indvar_flatten_op_fu_439_p2;
wire   [9:0] tmp_19_fu_456_p3;
wire   [10:0] p_shl1_cast_fu_463_p1;
wire   [10:0] tmp_4_mid2_cast_fu_453_p1;
wire   [10:0] tmp_21_fu_473_p1;
wire   [10:0] tmp_5_fu_467_p2;
wire   [10:0] tmp_22_fu_476_p2;
wire    ap_CS_fsm_state6;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
wire   [68:0] bound6_fu_329_p10;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        ...
        f_cast2_reg_518[4 : 0] <= f_cast2_fu_293_p1[4 : 0];
        f_cast_reg_513 <= f_cast_fu_289_p1;
        tmp_2_reg_530[5 : 0] <= tmp_2_fu_314_p1[5 : 0];
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten1_fu_341_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        ...
        tmp_20_reg_582 <= tmp_20_fu_429_p1;
    end
end

always @ (posedge ap_clk) begin
    if (((ap_start == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_15_reg_503 <= tmp_15_fu_261_p1;
...
assign bound6_fu_329_p2 = (69'd961 * bound6_fu_329_p1);
...
assign exitcond_flatten_fu_358_p2 = ((indvar_flatten_reg_220 == 37'd961) ? 1'b1 : 1'b0);
...
assign indvar_flatten_next1_fu_346_p2 = (indvar_flatten1_reg_200 + 69'd1);

assign indvar_flatten_next_fu_445_p3 = ((exitcond_flatten_fu_358_p2[0:0] === 1'b1) ? 37'd1 : indvar_flatten_op_fu_439_p2);

assign indvar_flatten_op_fu_439_p2 = (indvar_flatten_reg_220 + 37'd1);

assign j_2_fu_408_p2 = (5'd1 + j_mid_fu_364_p3);

assign j_mid_fu_364_p3 = ((exitcond_flatten_fu_358_p2[0:0] === 1'b1) ? 5'd0 : ap_phi_mux_j_phi_fu_235_p4);
...
assign p_shl1_cast_fu_463_p1 = tmp_19_fu_456_p3;

assign smax3_cast_fu_279_p1 = smax3_fu_271_p3;

assign smax3_fu_271_p3 = ((tmp_3_fu_265_p2[0:0] === 1'b1) ? tmp_12_fu_251_p1 : tmp_fu_255_p2);

assign tmp_11_cast_fu_318_p1 = tmp_s_fu_308_p2;

assign tmp_12_fu_251_p1 = c[5:0];

assign tmp_14_cast_fu_322_p1 = $signed(tmp_4_reg_508);

assign tmp_15_fu_261_p1 = c[2:0];

assign tmp_17_cast_fu_487_p1 = tmp_6_reg_597;

assign tmp_17_t_mid2_fu_391_p2 = (tmp_18_fu_387_p1 - tmp_15_reg_503);

assign tmp_17_t_mid2_v_v_fu_379_p3 = ((exitcond_flatten_fu_358_p2[0:0] === 1'b1) ? i_1_fu_352_p2 : ap_phi_mux_i_phi_fu_214_p4);

assign tmp_18_fu_387_p1 = tmp_17_t_mid2_v_v_fu_379_p3[2:0];

assign tmp_19_fu_456_p3 = {{tmp_4_mid2_reg_563}, {5'd0}};

assign tmp_20_fu_429_p1 = k_mid2_fu_414_p3[10:0];

assign tmp_21_fu_473_p1 = $unsigned(f_cast_reg_513);

assign tmp_22_fu_476_p2 = (tmp_20_reg_582 - tmp_21_fu_473_p1);

assign tmp_2_fu_314_p1 = tmp_s_fu_308_p2;

assign tmp_3_fu_265_p2 = ((tmp_12_fu_251_p1 > tmp_fu_255_p2) ? 1'b1 : 1'b0);

assign tmp_4_fu_283_p2 = (smax3_cast_fu_279_p1 - c);
...
assign tmp_6_fu_481_p2 = (tmp_5_fu_467_p2 + tmp_22_fu_476_p2);

assign tmp_fu_255_p2 = (6'd8 + tmp_12_fu_251_p1);

assign tmp_s_fu_308_p2 = (6'd31 + f_cast2_cast1_fu_297_p1);

always @ (posedge ap_clk) begin
    f_cast2_reg_518[31:5] <= 27'b000000000000000000000000000;
    tmp_2_reg_530[31:6] <= 26'b00000000000000000000000000;
end
