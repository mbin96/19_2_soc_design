...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXIS:SLOT_1_AXIS:SLOT_2_AXI:SLOT_3_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 50000000, PHASE 0.000" *) input clk;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe10(net_slot_2_axi_ar_cnt),
        .probe11(net_slot_2_axi_araddr),
        .probe12(net_slot_2_axi_arlen),
        .probe13(net_slot_2_axi_arsize),
        .probe14(net_slot_2_axi_aw_cnt),
        .probe15(net_slot_2_axi_awaddr),
        .probe16(net_slot_2_axi_awlen),
        .probe17(net_slot_2_axi_awsize),
        .probe18(net_slot_2_axi_b_cnt),
        .probe19(net_slot_2_axi_r_cnt),
        .probe2(net_slot_0_axis_tvalid),
        .probe20(net_slot_2_axi_rdata),
        .probe21(net_slot_2_axi_rresp),
        .probe22(net_slot_2_axi_wdata),
        ...
        .probe37(net_slot_3_axi_bresp),
        .probe38(net_slot_3_axi_r_cnt),
        .probe39(net_slot_3_axi_rdata),
        .probe4(net_slot_0_axis_tlast),
        .probe40(net_slot_3_axi_wdata),
        .probe41(net_slot_3_axi_wstrb),
        .probe42(net_slot_3_axi_aw_ctrl),
        .probe43(net_slot_3_axi_w_ctrl),
        .probe44(net_slot_3_axi_b_ctrl),
        .probe45(net_slot_3_axi_ar_ctrl),
        .probe46(net_slot_3_axi_r_ctrl),
