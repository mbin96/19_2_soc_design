...
HD_PWD='C:/Users/mbin9/Documents/19-2-project/19_2_soc_design/work/ip_fft_pipe/ip_fft_pipe.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_Top_FFT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_Top_FFT.tcl
