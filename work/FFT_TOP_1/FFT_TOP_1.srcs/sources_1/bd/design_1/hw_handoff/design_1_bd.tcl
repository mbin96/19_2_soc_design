...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_slave_FFT_f_ps_0, and set properties
  set axi_slave_FFT_f_ps_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_slave_FFT_f_ps:1.0 axi_slave_FFT_f_ps_0 ]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {2} \
   CONFIG.NUM_WRITE_OUTSTANDING {2} \
 ] [get_bd_intf_pins /axi_slave_FFT_f_ps_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins axi_slave_FFT_f_ps_0/S_AXI]
...
HDL_ATTRIBUTE.DEBUG {true} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_slave_FFT_f_ps_0/S_AXI_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk] [get_bd_pins system_ila_0/clk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_slave_FFT_f_ps_0/S_AXI_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_slave_FFT_f_ps_0/S_AXI/reg0] SEG_axi_slave_FFT_f_ps_0_reg0
