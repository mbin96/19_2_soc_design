...
HD_PWD='C:/Users/mbin9/Documents/19-2-project/19_2_soc_design/work/FFFFFT/FFFFFT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_FFT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_FFT.tcl
